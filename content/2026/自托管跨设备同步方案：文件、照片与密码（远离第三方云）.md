...
- **KeePass + Strongbox + KeePassXC**：用单个 `.kdbx` 密码库管理所有密码
...
Syncthing 在 iOS 上不太好用，要做“相册自动上传”，Nextcloud 是目前自托管里最省心的方案之一。
